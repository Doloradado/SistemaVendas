...
import sistemavendas.usuarios.AdminMenu;
import sistemavendas.usuarios.GerenteMenu;
import sistemavendas.usuarios.UsarioMenu;
            ...
            if (!usuarioLogado) {
                ...
                switch (tipoUsuario) {
                    ...
                    case "gerente":
                        ...
                        break;
                    case "usuario":
                        UsarioMenu.usuarioMenu(usuarioService, comprarProduto, scanner, usuarioAtual, usuarioLogado, tipoUsuario);
                        break;
                    default:
                        break;
                }
